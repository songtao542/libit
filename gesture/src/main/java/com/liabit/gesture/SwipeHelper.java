...
public class SwipeHelper {
    ...
    public SwipeHelper(int swipeDirection, Callback callback, Context context) {
        ...
        mFalsingThreshold = (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, 70, res.getDisplayMetrics());
        mFadeDependingOnAmountSwiped = false;
                            ...
                            public void run() {
                                if (mCurrView != null && !mLongPressSent) {
                                    ...
                                    if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N) {
                                        mCurrView.performLongClick(x, y);
                                    } else {
                                        mCurrView.performLongClick();
                                    }
                                }
                            }
                        };
    ...
    public void dismissChild(final View animView, float velocity, final Runnable endAction,
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.JELLY_BEAN_MR1) {
            isLayoutRtl = animView.getLayoutDirection() == View.LAYOUT_DIRECTION_RTL;
        }
        ...
        if (useAccelerateInterpolator) {
            anim.setInterpolator(FlingAnimationUtils.FAST_OUT_LINEAR_IN);
        ...
        anim.addListener(new AnimatorListenerAdapter() {
            ...
            public void onAnimationEnd(Animator animation) {
                ...
                boolean shouldRemove = mCallback.shouldRemoveChild(animView);
                if (!mCancelled || shouldRemove) {
    ...
    public interface Callback {
        ...
        boolean canChildBeDismissed(View child);

        boolean isAntiFalsingNeeded();

        void onBeginDrag(View child);

        void onChildDismissed(View child);

        boolean shouldRemoveChild(View child);

        void onDragCancelled(View child);
         ...
         */
        boolean canChildBeDragged(View animView);
    }


    public static class FlingAnimationUtils {

        public static final Interpolator FAST_OUT_SLOW_IN = PathInterpolatorCompat.create(0.4f, 0f, 0.2f, 1f);
        public static final Interpolator FAST_OUT_LINEAR_IN = PathInterpolatorCompat.create(0.4f, 0f, 1f, 1f);
        public static final Interpolator LINEAR_OUT_SLOW_IN = PathInterpolatorCompat.create(0f, 0f, 0.2f, 1f);
        ...
        private AnimatorProperties getProperties(float currValue,
            ...
            if (durationSeconds <= maxLengthSeconds) {
                ...
                InterpolatorInterpolator superInterpolator = new InterpolatorInterpolator(
                        velocityInterpolator, slowInInterpolator, LINEAR_OUT_SLOW_IN);
                mAnimatorProperties.interpolator = superInterpolator;
            } else {

                // Just use a normal interpolator which doesn't take the velocity into account.
                durationSeconds = maxLengthSeconds;
                mAnimatorProperties.interpolator = FAST_OUT_SLOW_IN;
            }
        ...
        private Interpolator getInterpolator(float startGradient, float velocityFactor) {
            if (startGradient != mCachedStartGradient
                ...
                mInterpolator = PathInterpolatorCompat.create(speedup, speedup * startGradient, mLinearOutSlowInX2, mY2);
        ...
        private AnimatorProperties getDismissingProperties(float currValue, float endValue,
            ...
            Interpolator mLinearOutFasterIn = PathInterpolatorCompat.create(0, 0, LINEAR_OUT_FASTER_IN_X2, y2);
            float durationSeconds = startGradient * diff / velAbs;
            if (durationSeconds <= maxLengthSeconds) {
                ...
                VelocityInterpolator velocityInterpolator
                        = new VelocityInterpolator(durationSeconds, velAbs, diff);
                InterpolatorInterpolator superInterpolator = new InterpolatorInterpolator(
                        velocityInterpolator, mLinearOutFasterIn, LINEAR_OUT_SLOW_IN);
                mAnimatorProperties.interpolator = superInterpolator;
            } else {

                // Just use a normal interpolator which doesn't take the velocity into account.
                durationSeconds = maxLengthSeconds;
                mAnimatorProperties.interpolator = FAST_OUT_LINEAR_IN;
            }
            mAnimatorProperties.duration = (long) (durationSeconds * 1000);
            return mAnimatorProperties;
        }
         ...
         */
        private final class InterpolatorInterpolator implements Interpolator {
         ...
         */
        private final class VelocityInterpolator implements Interpolator {
        ...
        private class AnimatorProperties {
