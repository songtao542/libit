 ...
 */
abstract class BaseVBFragment<VB : ViewBinding> : Fragment(), Toolbar.OnMenuItemClickListener, ProgressDialog, OnBackListener, BackEventDispatcher {
