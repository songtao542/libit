 ...
 * </pre>
 *
 * <p>The GreeAlertDialog class takes care of automatically setting
 ...
 * </div>
 */
public class GreeAlertDialog extends AlertDialog implements DialogInterface {
    ...
    protected GreeAlertDialog(Context context) {
        this(context, 0);
    }

    /**
     * Construct an GreeAlertDialog that uses an explicit theme.  The actual style
     * that an GreeAlertDialog uses is a private implementation, however you can
     * here supply either the name of an attribute in the theme from which
     * to get the dialog's style.
     */
    protected GreeAlertDialog(Context context, int themeResId) {
        super(context, resolveDialogTheme(context, themeResId));
        mAlert = new AlertController(getContext(), this, getWindow());
    }

    protected GreeAlertDialog(Context context, boolean cancelable, OnCancelListener cancelListener) {
        this(context, 0);
    ...
    public static class Builder extends AlertDialog.Builder{
         ...
         *
         * @param context the parent context Non null
         */
         ...
         * style resource containing a fully-populated theme, to replace all
         * attributes in the parent {@code context}'s theme including primary
         * and accent colors.
         * <p>
         * To preserve attributes such as primary and accent colors, the
         * {@code themeResId} may instead be specified as an overlay theme . This will
         ...
         * array.foo The list will have a check mark displayed to the right of the text for the
        ...
        public Builder setMessageCenter(boolean center) {
            P.mIsMessageCenter = center;
            return this;
        }
        public Builder setCanceledOnTouchOutside(boolean cancel) {
            P.mIsCanceledOnTouchOutside = cancel;
            return this;
        }
        public Builder setDismissOnClickBtn(boolean enabled) {
            P.mIsDismissOnClickBtn = enabled;
            return this;
        }
        public Builder setTitleTextSize(int sizePx) {
            P.mTitleTextSize = sizePx;
            return this;
        }
        /**
         * Creates an {@link GreeAlertDialog} with the arguments supplied to this
         * builder.
         * <p>
         ...
         */
        public GreeAlertDialog create() {
            // We can't use Dialog's 3-arg constructor with the createThemeContextWrapper param,
            // so we always have to re-set the theme
            final GreeAlertDialog dialog = new GreeAlertDialog(P.mContext, mTheme);
            P.apply(dialog.mAlert);
            dialog.setCancelable(P.mCancelable);
            if (P.mCancelable) {
                //dialog.setCanceledOnTouchOutside(true);
                dialog.setCanceledOnTouchOutside(P.mIsCanceledOnTouchOutside);
            }
         ...
         * <pre>
         *     GreeAlertDialog dialog = builder.create();
         *     dialog.show();
         * </pre>
         */
        public GreeAlertDialog show() {
            final GreeAlertDialog dialog = create();
            dialog.show();
            return dialog;
        }
    }
