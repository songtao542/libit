...
class ProgressBar : View {
    ...
    private fun init(context: Context, attrs: AttributeSet?, defStyleAttr: Int, defStyleRes: Int) {
        mRing = Ring()
        mRing.colors = intArrayOf(ResourcesCompat.getColor(context.resources, R.color.ml_menu_text_color, context.theme))
        mRing.setStrokeCap(Cap.SQUARE)
        mRing.setStrokeJoin(Paint.Join.MITER)
        mRing.strokeWidth = TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, 2f, context.resources.displayMetrics)
