 ...
 * @Date: 2018/2/8 21:22
 */
public class GridListAdapter extends RecyclerView.Adapter<com.liabit.listpicker.HotItemListAdapter.GridViewHolder> {
    public static final int SPAN_COUNT = 3;

    private Context mContext;
    private List<HotListItem> mData;
    private com.liabit.listpicker.InnerListener mInnerListener;

    public GridListAdapter(Context context, List<HotListItem> data) {
    ...
    public void onBindViewHolder(GridViewHolder holder, int position) {
        ...
        holder.name.setSelected(data.isSelected());
