...
public class UCropActivity extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mThemeId = intent.getIntExtra(UCrop.Options.EXTRA_THEME_ID, -1);
        if (mThemeId != -1) {
            setTheme(mThemeId);
        }
		// add by songtao --end--
    ...
    private void setupAppBar() {
		...
		// modify by songtao --start--
        Drawable drawable = ContextCompat.getDrawable(this, mToolbarCancelDrawable);
        Drawable stateButtonDrawable = drawable != null ? drawable.mutate() : null;
