...
import cn.lolii.cropper.photos.views.TiledImageRenderer.TileSource;
import cn.lolii.cropper.photos.views.TiledImageView;

public class CropView extends TiledImageView implements OnScaleGestureListener, GestureDetector.OnGestureListener {
