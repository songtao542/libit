package com.liabit.citypicker.db;
...
import static com.liabit.citypicker.db.DBConfig.COLUMN_C_CODE;
import static com.liabit.citypicker.db.DBConfig.COLUMN_C_NAME;
import static com.liabit.citypicker.db.DBConfig.COLUMN_C_PINYIN;
import static com.liabit.citypicker.db.DBConfig.COLUMN_C_PROVINCE;
import static com.liabit.citypicker.db.DBConfig.LATEST_DB_NAME;
import static com.liabit.citypicker.db.DBConfig.DB_NAME_V1;
import static com.liabit.citypicker.db.DBConfig.TABLE_NAME;
...
public class DBManager {
    ...
    public List<Item> getAllCities(){
        ...
        while (cursor.moveToNext()){
            ...
            city = new Item(name, province, pinyin, code);
            result.add(city);
        }
        cursor.close();
        db.close();
    ...
    public List<Item> searchCity(final String keyword){
        ...
        while (cursor.moveToNext()){
            ...
            String pinyin = cursor.getString(cursor.getColumnIndex(COLUMN_C_PINYIN));
            String code = cursor.getString(cursor.getColumnIndex(COLUMN_C_CODE));
            Item city = new Item(name, province, pinyin, code);
            result.add(city);
        }
        cursor.close();
        db.close();
     ...
     * sort by a-z
     */
    private static class CityComparator implements Comparator<Item>{
        @Override
