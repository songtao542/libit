package cn.lolii.cropper.photos.views;
...
import cn.lolii.cropper.glrenderer.GLCanvas;
import cn.lolii.cropper.glrenderer.UploadedTexture;
...
public class TiledImageRenderer {
    ...
    private static final Pools.Pool<Bitmap> sTilePool = new Pools.SynchronizedPool<>(64);
