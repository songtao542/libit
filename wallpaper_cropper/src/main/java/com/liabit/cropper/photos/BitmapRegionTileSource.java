...
import com.liabit.cropper.glrenderer.BitmapTexture;
import com.liabit.cropper.photos.views.TiledImageRenderer;
import com.liabit.cropper.util.BitmapUtils;
...
public class BitmapRegionTileSource implements TiledImageRenderer.TileSource {
    ...
    static class SimpleBitmapRegionDecoderWrapper implements SimpleBitmapRegionDecoder {
    ...
    static class DumbBitmapRegionDecoder implements SimpleBitmapRegionDecoder {
        Bitmap mBuffer;
        Canvas mTempCanvas;
        Paint mTempPaint;
