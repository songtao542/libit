...
public final class SelectionCreator {
    ...
    public SelectionCreator crop(float aspectRatioX, float aspectRatioY) {
        mSelectionSpec.crop = true;
        mSelectionSpec.aspectRatioX = aspectRatioX;
        mSelectionSpec.aspectRatioY = aspectRatioY;
        return this;
    }

    public SelectionCreator crop(float aspectRatioX, float aspectRatioY, int maxWidth, int maxHeight) {
        mSelectionSpec.crop = true;
        mSelectionSpec.aspectRatioX = aspectRatioX;
        mSelectionSpec.aspectRatioY = aspectRatioY;
